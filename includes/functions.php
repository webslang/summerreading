...
$program_reg_for = filter_input(INPUT_POST,'$program_reg_for', FILTER_SANITIZE_NUMBER_STRING);
$first_name = filter_input(INPUT_POST,'first_name', FILTER_SANITIZE_NUMBER_STRING);
$last_name = filter_input(INPUT_POST,'last_name', FILTER_SANITIZE_NUMBER_STRING);
$email = filter_input(INPUT_POST, 'email', FILTER_SANITIZE_EMAIL);
$zip_code = filter_input(INPUT_POST, 'zip_code', FILTER_SANITIZE_NUMBER_INT);
$school_attend = filter_input(INPUT_POST,'school_attend', FILTER_SANITIZE_NUMBER_STRING);
$grade_level = filter_input(INPUT_POST, 'grade_level', FILTER_SANITIZE_NUMBER_INT);
